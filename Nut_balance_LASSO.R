...
V1_las <- predict(V1.las, HSTXTv)
V2_las <- predict(V2.las, HSTXTv)
V3_las <- predict(V3.las, HSTXTv)
V4_las <- predict(V4.las, HSTXTv)
V5_las <- predict(V5.las, HSTXTv)
V6_las <- predict(V6.las, HSTXTv)
