...
While this is just a recommendation schema (i.e., informed opinion) that farmers could take or leave, there are of course both much more complex and more dynamic social/economic/environmental interactions at play, e.g., between the applications of lime, nitrogen fertilizers, other nutrient remediation measures, existing cropping systems, investment risk aversion, water-use and greenhouse gas emissions that should be considered. These will require systematic and spatially/temporally representative field trials to monitor any potential socio-economic constraints and also any potentially associated environmental side effects. Systematic agronomic field trials should also be used to (in)validate and challenge any of the inherent assumptions that are made in using Hp for making soil-test-based liming recommendations to farmers. However, that is also true for any other purely soil-test-based procedure that might be used for issuing such recommendations. 
