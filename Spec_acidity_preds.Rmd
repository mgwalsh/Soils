...
The other main option is of course to run both types of algorithms (the data regularization-based and the data reduction-based ones) and then look at if they can be usefully combined. This is the approach that I will take here.
