...
* This notebook produces precise & accurate spectral predictions of the *reserve acidity* of soils (which are commonly used for providing liming recommendations) based on a completely reproducible, *standard* ensemble machine learning workflow (e.g., see [Rocca, 2019](https://towardsdatascience.com/ensemble-methods-bagging-boosting-and-stacking-c9214a10a205)).
