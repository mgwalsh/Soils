...
```{r}
# Package names
packages <- c("osfr", "downloader", "caret", "caretEnsemble", "MASS", "pls", "glmnet", "randomForest", "xgboost", "Cubist", "quantreg", "leaflet", "htmlwidgets", "plyr", "dplyr", "doParallel")
...
# Download figures ... another way to download
download("https://osf.io/42gry/?raw=1", "figures.zip", mode = "wb")
exdir <- "./Figures" 
