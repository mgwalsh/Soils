...
* The workflow's predictions could be used reliably to improve the precision, reduce the costs of and the environmental footprints of soil acidity monitoring in survey, mapping, experimental, monitoring and/or operational applications that focus on soil acidity (or alternatively salinity/sodicity) management of agricultural land.

Computationally the calibration and validation code for this notebook is somewhat challenging in R ... and requires patience because it runs relatively slowly on a *normal computer* (8 core, 16 Gb ... >1 hour). I will try to update it to include cloud-based and or GPU solutions to it in the future as needed or requested.
