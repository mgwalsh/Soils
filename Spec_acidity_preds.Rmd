...
* The workflow can be flexibly extended to model and predict other soil acidity related variables (e.g., pH, eCEC, EC, SOC, Ca:Mg, K, Na and metal oxides among others). It can also be rapidly extended to support new geographical regions of interest and soil testing laboratories operationally.
