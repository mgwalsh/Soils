...
* The workflow can be flexibly extended to model and predict other soil acidity related variables (e.g., pH, eCEC, EC, Ca, Mg, K, and Na among others). It can also be rapidly extended to cover new and ROIs and soil testing laboratories operationally.
