...
* The main note of caution is that soil-test-based liming recommendations (among others) should always be contextualized within specific crop production environments. Soil tests are basically not enough to provide useful and reliable extension advice to farmers.
