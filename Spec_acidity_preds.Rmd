...
The other main option is of course to run both types of algorithms (data selection and data reduction based) and then look at if they can be usefully combined. This is the approach that I will take here.
