...
Note that I also include soil pH (in water) in the calibration features beacuse it is routinely, quickly and cheaply measured in most soil spectral labs (and frequently even in the field). It is also closely related to Hp. The general notion is that soils with a pH > 7 is unlikely to have any measurable reserve acidity. See the figure below.
