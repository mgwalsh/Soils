...
\
```{r, echo=FALSE, fig.align="center", fig.cap="AfSIS schema for field-crop, soil-test based (topsoil, 0-50 cm) Aglime recommendations (LR, in kg ha^-1^ CCE).", out.width = '60%'}
