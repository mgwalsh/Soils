...
Computationally the calibration and validation code for this notebook are somewhat challenging in R ... and require patience because they run relatively slowly on a *normal computer* (8 core, 16 Gb ... >1 hour). I will try to update the code to include cloud-based and/or GPU solutions to those for larger datasets in the future as needed and/or requested.
