---
title: Spectral predictions for diagnosing reserve soil acidity and potential lime requirements
author: M.G. Walsh
...
```{r, echo=FALSE, fig.align="center", fig.cap="AfSIS schema for field-crop, soil-test based (topsoil, 0-20 cm) ag lime recommendations (LR, in kg ha^-1^ CCE).", out.width = '70%'}
knitr::include_graphics("./soil_acidity/Figures/Lime requirement.png")
```

However, there are also both more complex and more dynamic economic/environmental interactions between the applications of lime, nitrogen fertilizers, other nutrient remediation measures and greenhouse gas emissions that should be considered. These require systematic field trials to monitor any potential socio-economic constraints and any potentially associated environmental side effects.
