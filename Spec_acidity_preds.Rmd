...
* The workflow outputs can be used to improve the precision, reduce the costs of and the environmental footprints of soil acidity monitoring in survey, mapping, experimental, monitoring and/or (potentially) operational applications that focus on soil acidity (or alternatively salinity/sodicity) management.
