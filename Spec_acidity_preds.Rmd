...
* The workflow's predictions can be used reliably to improve the precision, reduce the costs of and the environmental footprints of soil acidity monitoring in survey, mapping, experimental, monitoring and/or operational applications that focus on soil acidity (or alternatively salinity/sodicity) management.
