...
```{r, fig.align = "center", figures-side, fig.show='hold', out.width="50%", fig.cap = "Quantile regression fits of modeled vs observed reserve acidity (Hp). The blue lines are the 5% and 95% quantile regression estimates. On the left are the stacked model predictions, `st`. On the right are the `cubist` based predictions."}
