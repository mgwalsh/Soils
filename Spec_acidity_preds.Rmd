...
* The workflow can be flexibly extended to model and predict other soil acidity related variables (e.g., pH, eCEC, EC, SOC, exCa, exMg, exK, and exNa among others). It can also be rapidly extended to cover new geographical ROIs and soil testing laboratories operationally.

* The workflow outputs can be used to improve the precision, reduce the costs of and the environmental footprints of soil acidity monitoring in survey, experimental and/or potentially operational applications that focus on soil acidity management.
