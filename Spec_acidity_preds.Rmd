...
* The workflow can be flexibly changed to model and predict other soil acidity related variables (e.g., pH, EC, CEC, SOC, Ca:Mg and other metal oxides among others). It can also be rapidly extended to support new geographical regions of interest and/or soil testing laboratories operationally.
