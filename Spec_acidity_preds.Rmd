...
* The note of caution is that soil-test-based liming recommendations (among others) should always be contextualized to specific crop production environments. Soil tests are basically not enough for providing reliable farmer extension advice.
