...
* The workflow can be flexibly extended to model and predict other soil acidity related variables (e.g., pH, xCEC, EC, SOC, Ca:Mg, K, and Na among others). It can also be rapidly extended to cover new geographical regions of interest and soil testing laboratories operationally.
