...
However, there are also both more complex and more dynamic economic/environmental interactions between the applications of lime, nitrogen fertilizers, other nutrient remediation measures, cropping systems and water-use and greenhouse gas emissions that should be considered. These require systematic field trials to monitor any potential socio-economic constraints and any potentially associated environmental side effects. Systematic agronomic field trials should also be used to (in)validate and challenge the inherent assumptions that are made in using Hp for making soil-test-based liming recommendations to farmers. However, that is also true for any other soil-test-based procedure that might be used for issuing such recommendations. 
