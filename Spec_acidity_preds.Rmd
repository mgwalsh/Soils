...
* The main note of caution is that soil-test-based liming recommendations (among other agronomic recommendations) should always be contextualized to specific crop production environments. Simple soil tests are basically not enough to provide useful, reliable and replicable extension advice to farmers.
